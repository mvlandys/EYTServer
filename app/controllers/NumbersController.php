...
class NumbersController extends Controller
{
    public function saveEntries()
    {
        ...
        Mail::send('email_log', [], function($message) {
            $message->to(["mathew@icrm.net.au"])->subject("Numbers Log " . date("H:i:s d/m/Y"));
        });
    ...
    public function showResults($test_name = null, $start = null, $end = null)
    {
        ...
        return View::make("numbers/results", ["games"     => $games,
                                              "test_name" => $test_name,
    ...
    public function viewScores($game_id)
    {
        ...
        return View::make("numbers/scores", ["scores" => $scores]);
    }
    ...
    public function fixDuplicates()
    {
        ...
        foreach ($games as $game) {
            ...
            foreach ($duplicates as $duplicate) {
                NumbersScore::where("game_id", "=", $duplicate->id)->delete();
                NumbersGame::where("id", "=", $duplicate->id)->delete();
    ...
    public function deleteGames()
    {
        ...
        $gameRep = new Games(new NumbersGame());
        return $gameRep->deleteGames(new NumbersScore(), $games);
    }
}