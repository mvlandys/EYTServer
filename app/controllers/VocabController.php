...
class VocabController extends Controller
{
    public function saveGamesNew()
    {
        ...
        foreach ($games as $gameData) {
            ...
            $game->test_name  = (empty($gameData["user_data"]["test_name"])) ? "" : $gameData["user_data"]["test_name"];
    ...
    public function showResultsNew($test_name = null, $start = null, $end = null)
    {
        ...
        return View::make("vocab/results_new", array(
            "games"     => $games,
            "test_name" => $test_name,
    ...
    public function viewScoresNew($game_id)
    {
        ...
        return View::make("vocab/scores", array(
            "scores" => $scores,
            "names"  => array_values($this->cardNamesNew())
        ));
    }
    ...
    public function fixDuplicatesNew()
    {
        ...
        foreach ($games as $game) {
            ...
            $duplicates = VocabGameNew::where("id", "!=", $game->id)
                ->where("subject_id", "=", $game->subject_id)
                ->where("session_id", "=", $game->session_id)
                ->where("test_name", "=", $game->test_name)
                ->where("played_at", "=", $game->played_at)
    ...
    private function cardNames()
    {
        return array("Banana", "Door", "Book", "Fish", "Flower", "Spider", "Kangeroo",
            "Hammer", "Snake", "Teeth", "Belt", "Crocodile", "Piano", "Whale", "Grapes",
            "Toothbrush", "Umbrella", "Mountain", "Rainbow", "Triangle", "Penguin", "Feather",
            "Fountain", "Tent", "Moon", "Shell", "Snow", "Bridge", "Spaghetti", "Bucket",
            "Chain", "Guitar", "Ruler", "Giraffe", "Envelope", "Hippopotamus", "Diamond",
            "Calendar", "Arrow", "Screw", "Parachute", "Cactus", "Globe", "Peacock",
    ...
    {
        return array("Flower", "Door", "Snake", "Rainbow", "Crocodile", "Teeth", "Spider",
            "Toothbrush", "Shell", "Hammer", "Umbrella", "Giraffe", "Bucket", "Triangle",
            "Guitar", "Tent", "Mountain", "Whale", "Bridge", "Feather", "Piano",
            "Hippopotamus", "Snow", "Spaghetti", "Trumpet", "Submarine", "River", "Diamond",
