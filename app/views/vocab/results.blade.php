...
<table class="table table-bordered table-striped">
    ...
    @foreach ($games as $game)
        <tr>
            ...
            <td class="text-center"><a class="btn btn-danger btn-xs btnDeleteGame" data-game_id="{{ $game->id }}" data-game_type="vocab" data-confirm="0"><i class="glyphicon glyphicon-trash"></i></a></td>
        </tr>
    @endforeach
    </tbody>
</table>
