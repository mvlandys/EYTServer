...
<div class="well">
    <div class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-primary" id="btnNumbersFilter">Submit</a>
        </div>
    </div>
</div>
...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <th><a class="btn btn-warning btn-xs" id="btnNumbersCSV">CSV</a></th>
    ...
    @foreach ($games as $game)
        <tr id="row{{ $game->id }}">
            <td><a class="btn btn-info btn-sm" href="/numbers/game/{{ $game->id }}">View Scores</a></td>
            ...
            <td class="text-center">
                <a class="btn btn-danger btn-xs btnDeleteGame" data-last_id="{{ $lastID }}" data-game_id="{{ $game->id }}" data-game_type="numbers" data-confirm="0">
