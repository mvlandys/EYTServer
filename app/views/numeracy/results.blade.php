...
<input type="hidden" name="game" value="numbers" />
...
<div class="well">
    <div class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-primary" id="btnNumeracyFilter">Submit</a>
        </div>
    </div>
</div>
...
<table class="table table-bordered table-striped">
    <thead>
    <tr>
        <th><a class="btn btn-warning btn-xs" id="btnNumeracyCSV">CSV</a></th>
    ...
    @foreach ($games as $game)
        <tr id="row{{ $game->id }}">
            <td><a class="btn btn-info btn-sm" href="/numeracy/game/{{ $game->id }}">View Scores</a></td>
            ...
            <td class="text-center">
                <a class="btn btn-danger btn-xs btnDeleteGame" data-last_id="{{ $lastID }}" data-game_id="{{ $game->id }}" data-game_type="numeracy" data-confirm="0">
